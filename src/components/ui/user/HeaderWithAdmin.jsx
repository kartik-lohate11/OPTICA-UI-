...
import { Menu, X, ShoppingCart, User, LogOut, Settings, Mail, Phone, ChevronDown, Eye, EyeOff, Lock, Calendar, Clock, MapPin, CheckCircle, Shield } from 'lucide-react';
...
// UserDropdown Component (same as before)
const UserDropdown = ({ user, onLogout, onOpenAdmin }) => {
...
// BookEyeTestModal Component (simplified for space - use the full version from before)
...
//           <h2 className="text-2xl font-bold text-black mb-4">Book Eye Test</h2>
//           <p className="text-gray-600">Booking form for {user?.name}</p>
//           <button onClick={onClose} className="mt-4 w-full bg-black text-white py-3 rounded-lg font-semibold">
//             Close
//           </button>
//         </div>
//       </div>
...
export const Header = () => {
  ...
  const handleLogin = (formData) => {
    setUser({
      ...
      isAdmin: true // In production, this would come from backend
    });
  ...
  // If admin portal is open, render only the portal
